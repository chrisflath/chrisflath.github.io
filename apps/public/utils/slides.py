...
class Slide:
    ...
    def render_slide(
        ...
        if self.layout_type == "title-slide":
            ...
            top = self.content1.style({"width": "100%", "height": "50%"})
            bot = self.content2.style({"width": "100%", "height": "50%"})
            ...
            top = self.content1.style({"width": "100%", "height": "33%"})
            mid = self.content2.style({"width": "100%", "height": "33%"})
            bot = self.content3.style({"width": "100%", "height": "33%"})
            content = mo.vstack(
